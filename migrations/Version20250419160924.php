 ...
 */
final class Version20250419160924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD products_summary LONGTEXT DEFAULT NULL, CHANGE code_postal code_postal VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP products_summary, CHANGE code_postal code_postal INT NOT NULL');
    }
}
